...
// ─── Briefs (Enhanced) ───
const briefs = [
  { id: "br1", keyword: "seo agency singapore", title: "Best SEO Agency in Singapore — Complete Guide", meta_description: "Find the best SEO agency in Singapore. Compare services, pricing, and results.", headings: [{ level: "H2", text: "What Makes a Great SEO Agency" }, { level: "H2", text: "Top SEO Services to Look For" }], faq: [{ question: "How much does SEO cost in Singapore?", answer: "SEO services in Singapore typically range from $500-$5000/month." }], entities: ["Singapore", "SEO"], internal_links: [], status: "approved" as const, created_at: daysAgo(14), page_type: "core_service", secondary_keywords: ["best seo company singapore", "seo services pricing singapore"], search_intent: "commercial", target_audience: "Business owners in Singapore looking for SEO services", page_goal: "Generate qualified leads for SEO services", recommended_slug: "/seo-agency", suggested_h1: "Singapore's Top SEO Agency — Proven Results", cta_angle: "Get a free SEO audit to see your growth potential", sections: [{ title: "What Makes a Great SEO Agency", guidance: "Cover selection criteria, red flags, and what to expect", word_count_target: 400 }, { title: "Our SEO Services", guidance: "Detail each service offering with outcomes", word_count_target: 600 }, { title: "Pricing & Packages", guidance: "Transparent pricing tiers with deliverables", word_count_target: 300 }, { title: "Case Studies & Results", guidance: "Real client results with metrics", word_count_target: 400 }], competitor_context: ["Competitor has 8 dedicated service pages vs our 3", "Competitor has FAQ schema on every service page"], audit_context: ["Current /seo-agency page is thin at 420 words — needs expansion to 1,500+", "Missing H1 tag on service page"], evidence: [{ type: "keyword" as const, source: "seo agency singapore", detail: "2,400 monthly searches, KD 55, strong commercial intent" }, { type: "competitor" as const, source: "competitor-one.com", detail: "Has 8 dedicated service pages with avg 1,800 words each" }, { type: "audit" as const, source: "/seo-agency", detail: "Missing H1, thin content (420 words), no FAQ section" }], priority: "high" as const, source_mapping_id: "kpm1" },
  { id: "br2", keyword: "web design singapore", title: "Professional Web Design Services Singapore", meta_description: "Expert web design services in Singapore. Custom, responsive, SEO-optimized websites.", headings: [{ level: "H2", text: "Web Design Process" }, { level: "H2", text: "Portfolio" }], faq: [{ question: "How long does a website take to build?", answer: "Typically 4-8 weeks depending on complexity." }], entities: ["web design", "Singapore"], internal_links: [], status: "draft" as const, created_at: daysAgo(7), page_type: "core_service", secondary_keywords: ["website redesign services", "ecommerce web design"], search_intent: "commercial", target_audience: "SMBs needing a new or redesigned website", page_goal: "Drive web design project inquiries", recommended_slug: "/web-design", suggested_h1: "Web Design Services in Singapore — Custom & Responsive", cta_angle: "See our portfolio and request a free design consultation", sections: [{ title: "Our Design Process", guidance: "Step-by-step overview of how we work", word_count_target: 400 }, { title: "Types of Websites We Build", guidance: "E-commerce, corporate, portfolio, landing pages", word_count_target: 500 }], competitor_context: ["Competitor splits web design into 4 sub-pages by type"], audit_context: ["No internal links from /web-design to sub-service pages"], evidence: [{ type: "keyword" as const, source: "web design singapore", detail: "3,200 monthly searches, KD 60" }], priority: "high" as const },
  { id: "br3", keyword: "seo consultant singapore", title: "SEO Consultant Singapore — Expert SEO Consulting", meta_description: "Hire an experienced SEO consultant in Singapore for strategic guidance.", headings: [{ level: "H2", text: "What Does an SEO Consultant Do?" }, { level: "H2", text: "Our Consulting Process" }], faq: [{ question: "What's the difference between an SEO consultant and an agency?", answer: "A consultant provides strategic guidance while an agency handles implementation." }], entities: ["SEO consultant"], internal_links: [{ from: "/seo-agency", to: "/seo-consultant", anchor: "SEO consulting" }], status: "under_review" as const, created_at: daysAgo(3), page_type: "sub_service", secondary_keywords: [], search_intent: "commercial", target_audience: "Businesses wanting strategic SEO guidance", page_goal: "Book consulting sessions", recommended_slug: "/seo-consultant", suggested_h1: "Expert SEO Consultant in Singapore", cta_angle: "Book a 30-minute strategy call", sections: [{ title: "What We Cover", guidance: "Scope of consulting engagements", word_count_target: 300 }], competitor_context: ["Competitor offers standalone consulting page"], audit_context: [], evidence: [{ type: "keyword" as const, source: "seo consultant singapore", detail: "800 monthly searches, KD 45" }], priority: "medium" as const, source_mapping_id: "kpm7" },
  { id: "br4", keyword: "local seo services", title: "Local SEO Services — Dominate Local Search", meta_description: "Local SEO services to boost your Google Maps rankings and local visibility.", headings: [{ level: "H2", text: "Local SEO Strategy" }, { level: "H2", text: "Google Business Profile Optimization" }], faq: [{ question: "How long does local SEO take?", answer: "Expect initial results in 3-6 months." }], entities: ["local SEO", "Google Maps"], internal_links: [], status: "ready_for_publishing" as const, created_at: daysAgo(10), page_type: "location_page", secondary_keywords: ["local seo singapore"], search_intent: "commercial", target_audience: "Local businesses wanting foot traffic", page_goal: "Generate local SEO service leads", recommended_slug: "/local-seo", suggested_h1: "Local SEO Services — Get Found Locally", cta_angle: "Free local SEO audit for your business", sections: [{ title: "How Local SEO Works", guidance: "Overview of local ranking factors", word_count_target: 400 }], competitor_context: ["Competitor has 3 location-specific pages"], audit_context: ["Missing LocalBusiness schema on /local-seo"], evidence: [{ type: "keyword" as const, source: "local seo services", detail: "1,200 monthly searches" }], priority: "high" as const, source_mapping_id: "kpm5" },
];

// ─── Brief Drafts ───
const briefDrafts: Record<string, any[]> = {
  br1: [{ id: "brd1", brief_id: "br1", title: "Best SEO Agency in Singapore — Complete Guide", slug: "seo-agency", content: "# Singapore's Top SEO Agency — Proven Results\n\nLooking for the best SEO agency in Singapore? Whether you're a startup or an established enterprise, finding the right SEO partner can make the difference between online obscurity and dominating search results.\n\n## What Makes a Great SEO Agency\n\nThe best SEO agencies share several key traits:\n\n- **Proven Track Record**: Look for case studies with measurable results — rankings improvements, traffic growth, and revenue impact.\n- **Transparent Reporting**: Monthly reports should show exactly what was done and what results were achieved.\n- **Technical Expertise**: Strong technical SEO foundation including site audits, Core Web Vitals optimization, and crawl budget management.\n- **Content Strategy**: Not just keyword stuffing — strategic content that serves user intent and builds topical authority.\n\n## Our SEO Services\n\n### Technical SEO\nWe start with a comprehensive technical audit covering 200+ checkpoints. Our team fixes crawlability issues, optimizes site speed, and ensures proper indexation.\n\n### On-Page Optimization\nEvery page is optimized for target keywords with proper title tags, meta descriptions, heading structure, and internal linking.\n\n### Content Strategy\nWe develop data-driven content strategies that target the right keywords at every stage of the buyer journey.\n\n### Link Building\nWhite-hat link building through digital PR, guest posting, and strategic partnerships.\n\n## Pricing & Packages\n\n| Package | Monthly | Includes |\n|---------|---------|----------|\n| Starter | $1,500 | Technical SEO + 4 pages/month |\n| Growth | $3,000 | Full-service SEO + content |\n| Enterprise | $5,000+ | Custom strategy + dedicated team |\n\n## Case Studies & Results\n\n**E-commerce Client**: 340% organic traffic increase in 12 months\n**B2B SaaS**: From page 5 to position 2 for primary keyword\n**Local Business**: 5x increase in Google Maps visibility\n\n## Frequently Asked Questions\n\n### How much does SEO cost in Singapore?\nSEO services in Singapore typically range from $1,500-$5,000/month depending on scope and competitiveness.\n\n### How long does SEO take to show results?\nMost clients see meaningful improvements within 3-6 months, with compounding results over time.\n\n### Do you guarantee rankings?\nNo ethical SEO agency guarantees specific rankings. We guarantee our process, transparency, and effort.\n\n---\n\n**Ready to grow your organic traffic?** [Get a Free SEO Audit →](/contact)", meta_description: "Find the best SEO agency in Singapore. Compare services, pricing, and results from proven SEO experts.", version: 1, status: "approved", review_checks: [
    { id: "rc1", check_type: "cta_present", label: "CTA Present", status: "pass", detail: "Found CTA at end of article linking to /contact" },
    { id: "rc2", check_type: "word_count", label: "Word Count (1,500+ target)", status: "pass", detail: "Draft contains approximately 1,800 words" },
    { id: "rc3", check_type: "h1_match", label: "H1 Matches Brief", status: "pass", detail: "H1 matches suggested H1 from brief" },
    { id: "rc4", check_type: "faq_section", label: "FAQ Section Included", status: "pass", detail: "FAQ section with 3 questions included" },
    { id: "rc5", check_type: "internal_links", label: "Internal Links", status: "warning", detail: "Only 1 internal link found — brief suggests 3+" },
    { id: "rc6", check_type: "trust_elements", label: "Trust/Proof Elements", status: "pass", detail: "Case studies section with metrics included" },
    { id: "rc7", check_type: "brand_tone", label: "Brand Tone Review", status: "pending", detail: "Manual review required" },
    { id: "rc8", check_type: "technical_accuracy", label: "Technical Accuracy", status: "pending", detail: "Fact-check required for pricing and statistics" },
  ], internal_link_suggestions: [{ from: "/seo-agency", to: "/local-seo", anchor: "local SEO services" }, { from: "/seo-agency", to: "/web-design", anchor: "web design services" }, { from: "/blog/seo-tips", to: "/seo-agency", anchor: "professional SEO agency" }], created_at: daysAgo(12), updated_at: daysAgo(8) }],
  br3: [{ id: "brd2", brief_id: "br3", title: "Expert SEO Consultant in Singapore", slug: "seo-consultant", content: "# Expert SEO Consultant in Singapore\n\nNeed strategic SEO guidance without committing to a full-service retainer? Our SEO consulting services give you access to senior-level expertise on your terms.\n\n## What Does an SEO Consultant Do?\n\nAn SEO consultant provides strategic guidance, audits, and recommendations. Unlike a full-service agency, a consultant focuses on strategy and oversight while your team handles implementation.\n\n## Our Consulting Process\n\n1. **Discovery Call** — Understand your business, goals, and current SEO state\n2. **SEO Audit** — Comprehensive technical and content audit\n3. **Strategy Document** — Prioritized roadmap with clear actions\n4. **Monthly Reviews** — Ongoing guidance and performance tracking\n\n---\n\n**Book a 30-minute strategy call** to discuss your SEO goals.", meta_description: "Hire an experienced SEO consultant in Singapore for strategic guidance.", version: 1, status: "under_review", review_checks: [
    { id: "rc9", check_type: "cta_present", label: "CTA Present", status: "pass", detail: "CTA for strategy call at end" },
    { id: "rc10", check_type: "word_count", label: "Word Count (1,200+ target)", status: "fail", detail: "Only ~500 words — needs expansion to 1,200+" },
    { id: "rc11", check_type: "faq_section", label: "FAQ Section Included", status: "fail", detail: "Missing FAQ section from brief" },
    { id: "rc12", check_type: "trust_elements", label: "Trust/Proof Elements", status: "fail", detail: "No testimonials or case study references" },
  ], internal_link_suggestions: [{ from: "/seo-consultant", to: "/seo-agency", anchor: "full-service SEO" }], created_at: daysAgo(2), updated_at: daysAgo(1) }],
};
...
const routes: DemoRoute[] = [
  ...
  { pattern: /^\/keyword-research\/[^/]+$/, handler: () => {
    const clusters = [
      { id: "krc1", cluster_name: "SEO Services", cluster_theme: "Core service offerings", primary_keyword: "seo agency singapore", keyword_count: 5, avg_volume: 1800, avg_difficulty: 42, recommended_content_type: "core_service", priority: "high", sort_order: 0 },
      { id: "krc2", cluster_name: "Web Design", cluster_theme: "Design service offerings", primary_keyword: "web design singapore", keyword_count: 4, avg_volume: 1400, avg_difficulty: 38, recommended_content_type: "core_service", priority: "high", sort_order: 1 },
      { id: "krc3", cluster_name: "Content Marketing", cluster_theme: "Content strategy", primary_keyword: "content marketing agency", keyword_count: 3, avg_volume: 1100, avg_difficulty: 35, recommended_content_type: "sub_service", priority: "medium", sort_order: 2 },
      { id: "krc4", cluster_name: "Local SEO", cluster_theme: "Local optimization", primary_keyword: "local seo services", keyword_count: 3, avg_volume: 950, avg_difficulty: 30, recommended_content_type: "location_page", priority: "medium", sort_order: 3 },
    ];
    const kwData = [
      { kw: "seo agency singapore", vol: 2400, kd: 55, intent: "commercial", cpc: 8.50, cluster: "krc1", pageType: "core_service", existing: "/seo-agency", serp: ["people_also_ask", "local_pack"], scores: [92, 85, 88, 72, 80, 90] },
      { kw: "best seo company singapore", vol: 1800, kd: 52, intent: "commercial", cpc: 7.20, cluster: "krc1", pageType: "core_service", existing: "/seo-agency", serp: ["people_also_ask"], scores: [88, 82, 85, 70, 78, 85] },
      { kw: "seo services pricing singapore", vol: 1200, kd: 35, intent: "transactional", cpc: 12.00, cluster: "krc1", pageType: "sub_service", existing: null, serp: ["featured_snippet"], scores: [85, 90, 78, 82, 85, 75] },
      { kw: "technical seo audit", vol: 900, kd: 40, intent: "informational", cpc: 5.50, cluster: "krc1", pageType: "faq_page", existing: "/audit", serp: ["featured_snippet", "people_also_ask"], scores: [78, 75, 72, 78, 82, 70] },
      { kw: "seo consultant singapore", vol: 800, kd: 45, intent: "commercial", cpc: 9.00, cluster: "krc1", pageType: "sub_service", existing: null, serp: ["local_pack"], scores: [80, 80, 68, 70, 75, 82] },
      { kw: "web design singapore", vol: 3200, kd: 60, intent: "commercial", cpc: 6.80, cluster: "krc2", pageType: "core_service", existing: "/web-design", serp: ["people_also_ask", "image_pack"], scores: [90, 82, 92, 62, 78, 88] },
      ...
      { kw: "website redesign services", vol: 900, kd: 38, intent: "transactional", cpc: 8.00, cluster: "krc2", pageType: "sub_service", existing: null, serp: [], scores: [82, 88, 72, 78, 70, 78] },
      { kw: "ecommerce web design", vol: 1100, kd: 42, intent: "commercial", cpc: 7.50, cluster: "krc2", pageType: "sub_service", existing: null, serp: ["people_also_ask"], scores: [78, 82, 76, 74, 72, 80] },
      { kw: "content marketing agency", vol: 1600, kd: 48, intent: "commercial", cpc: 6.00, cluster: "krc3", pageType: "core_service", existing: "/content-marketing", serp: ["people_also_ask"], scores: [85, 80, 82, 68, 76, 82] },
      ...
      { kw: "blog content writing services", vol: 700, kd: 32, intent: "transactional", cpc: 5.00, cluster: "krc3", pageType: "sub_service", existing: null, serp: [], scores: [75, 85, 65, 82, 70, 72] },
      ...
      { kw: "google my business optimization", vol: 900, kd: 25, intent: "informational", cpc: 4.50, cluster: "krc4", pageType: "faq_page", existing: null, serp: ["featured_snippet", "video"], scores: [82, 75, 72, 88, 80, 70] },
      { kw: "local seo singapore", vol: 600, kd: 30, intent: "local", cpc: 6.50, cluster: "krc4", pageType: "location_page", existing: "/local-seo", serp: ["local_pack"], scores: [85, 80, 60, 85, 78, 88] },
    ];
    ...
    const mappings = [
      { id: "kpm1", page_url: "/seo-agency", page_title: "SEO Agency Singapore — Full Service SEO", page_type: "core_service", is_existing: true, keyword_count: 3, primary_keyword: "seo agency singapore", secondary_keywords: ["best seo company singapore", "seo services pricing singapore"], recommended_word_count: 2500, priority: "high", status: "suggested", parent_mapping_id: null, sort_order: 0 },
      { id: "kpm2", page_url: "/web-design", page_title: "Web Design Services Singapore", page_type: "core_service", is_existing: true, keyword_count: 2, primary_keyword: "web design singapore", secondary_keywords: ["ecommerce web design"], recommended_word_count: 2000, priority: "high", status: "suggested", parent_mapping_id: null, sort_order: 1 },
      { id: "kpm3", page_url: null, page_title: "Website Redesign Services — Modern & Responsive", page_type: "sub_service", is_existing: false, keyword_count: 2, primary_keyword: "website redesign services", secondary_keywords: ["responsive web design"], recommended_word_count: 1800, priority: "medium", status: "suggested", parent_mapping_id: "kpm2", sort_order: 2 },
      { id: "kpm7", page_url: null, page_title: "SEO Consulting Services Singapore", page_type: "sub_service", is_existing: false, keyword_count: 1, primary_keyword: "seo consultant singapore", secondary_keywords: [], recommended_word_count: 1500, priority: "medium", status: "suggested", parent_mapping_id: "kpm1", sort_order: 3 },
      { id: "kpm4", page_url: "/content-marketing", page_title: "Content Marketing Agency Singapore", page_type: "core_service", is_existing: true, keyword_count: 2, primary_keyword: "content marketing agency", secondary_keywords: ["blog content writing services"], recommended_word_count: 2000, priority: "medium", status: "suggested", parent_mapping_id: null, sort_order: 4 },
      { id: "kpm5", page_url: "/local-seo", page_title: "Local SEO Services — Dominate Local Search", page_type: "location_page", is_existing: true, keyword_count: 2, primary_keyword: "local seo services", secondary_keywords: ["local seo singapore"], recommended_word_count: 2000, priority: "high", status: "brief_created", parent_mapping_id: null, sort_order: 5 },
      { id: "kpm6", page_url: null, page_title: "Technical SEO Audit — Complete Guide", page_type: "faq_page", is_existing: false, keyword_count: 2, primary_keyword: "technical seo audit", secondary_keywords: ["content strategy for seo"], recommended_word_count: 2500, priority: "low", status: "suggested", parent_mapping_id: null, sort_order: 6 },
    ];
    const competitor_insights = [
      { domain: "competitor-one.com", finding: "Competitor has 8 dedicated service pages vs your 3 — including separate pages for SEO Audits, Link Building, and On-Page SEO", impact: "Their narrower page targeting likely captures more long-tail commercial keywords", priority: "high" },
      { domain: "competitor-one.com", finding: "Competitor has 5 location-specific service pages (e.g., /seo-agency-orchard, /seo-agency-cbd)", impact: "Missing location pages reduces local pack visibility for area-specific searches", priority: "high" },
      { domain: "rival-agency.sg", finding: "Rival has a comparison page '/seo-vs-ppc' that ranks for 12 commercial keywords", impact: "Comparison pages capture high-intent users evaluating options — currently a gap in your site", priority: "medium" },
      { domain: "competitor-one.com", finding: "Competitor has FAQ sections on each service page averaging 8 questions each", impact: "FAQ content supports People Also Ask visibility and improves topical relevance on service pages", priority: "medium" },
    ];
    const audit_insights = [
      { page: "/seo-agency", issue: "Missing H1 tag and thin content (420 words)", recommendation: "Add a clear H1 and expand content to at least 1,500 words with service-specific detail", severity: "critical" },
      { page: "/web-design", issue: "No internal links to sub-service pages", recommendation: "Add contextual links to ecommerce design, redesign, and responsive design sub-pages", severity: "warning" },
      { page: "/content-marketing", issue: "Duplicate meta description shared with /blog", recommendation: "Write a unique meta description focused on content marketing services and outcomes", severity: "warning" },
      { page: "/local-seo", issue: "Missing schema markup (LocalBusiness)", recommendation: "Add LocalBusiness structured data to strengthen local search signals", severity: "info" },
    ];
    return { id: "krj1", client_id: DEMO_CLIENT_ID, domain: "webby.sg", seed_topics: ["seo agency", "web design", "content marketing"], competitor_domains: ["competitor-one.com", "rival-agency.sg"], target_count: 15, target_location: "Singapore", target_language: "en", business_priority: "leads", provider: "mock", status: "completed", total_keywords: 15, clusters_count: 4, pages_mapped: 7, created_at: daysAgo(3), completed_at: daysAgo(3), results, clusters, mappings, competitor_insights, audit_insights };
  } },
  { pattern: /^\/clients\/[^/]+\/keyword-research$/, handler: () => [
    { id: "krj1", client_id: DEMO_CLIENT_ID, domain: "webby.sg", seed_topics: ["seo agency", "web design", "content marketing"], target_count: 15, target_location: "Singapore", target_language: "en", business_priority: "leads", provider: "mock", status: "completed", total_keywords: 15, clusters_count: 4, pages_mapped: 7, created_at: daysAgo(3), completed_at: daysAgo(3) },
  ] },
