...
const clients = [
  ...
  { id: "00000000-0000-0000-0000-000000000002", name: "TechStart Asia", domain: "techstart.asia", keywords_count: 28, competitors_count: 3, health_score: 65, status: "active", created_at: daysAgo(60), updated_at: now },
  { id: "00000000-0000-0000-0000-000000000003", name: "Green Living Co", domain: "greenliving.co", keywords_count: 15, competitors_count: 4, health_score: 52, status: "active", created_at: daysAgo(30), updated_at: now },
];
...
const publishingJobs = [
  ...
  { id: "pj4", client_id: "00000000-0000-0000-0000-000000000002", asset_type: "article" as const, asset_id: "art-x", platform: "wordpress", scheduled_time: null, job_type: "publish" as const, publish_status: "failed" as const, provider: "wordpress", external_post_id: null, published_url: null, error_message: "Connection refused: CMS endpoint unreachable", retry_count: 2, created_at: daysAgo(2), updated_at: daysAgo(1), client_name: "TechStart Asia" },
];

// ─── Analytics ───
const performanceSummary = {
  summary: { total_clicks: 12450, total_impressions: 285000, avg_ctr: 4.37, avg_position: 14.2, total_sessions: 8920 },
  topPages: [
    { page: "/seo-agency", clicks: 3200, impressions: 45000, ctr: 7.1, position: 4.2 },
    { page: "/web-design", clicks: 1800, impressions: 32000, ctr: 5.6, position: 8.1 },
    { page: "/blog/seo-tips", clicks: 1200, impressions: 28000, ctr: 4.3, position: 12.5 },
  ],
  topKeywords: [
    { keyword: "seo agency singapore", clicks: 2100, impressions: 18000, ctr: 11.7, position: 4.0 },
    { keyword: "web design singapore", clicks: 980, impressions: 15000, ctr: 6.5, position: 12.0 },
  ],
  insightCounts: [{ priority: "high", count: 3 }, { priority: "medium", count: 5 }],
};
...
const crmDeals = [
  { id: "crm-d1", client_id: DEMO_CLIENT_ID, contact_id: "crm-c1", deal_name: "TechCorp Monthly SEO", deal_value: 3500, deal_stage: "proposal", pipeline_name: "Sales Pipeline", expected_close_date: daysAgo(-14), won_date: null, lost_reason: null, notes: "Proposal sent, awaiting feedback", contact_name: "Michael Chen", contact_email: "michael@techcorp.sg", created_at: daysAgo(15), updated_at: daysAgo(3) },
  ...
  { id: "crm-d3", client_id: DEMO_CLIENT_ID, contact_id: "crm-c2", deal_name: "GreenStart Local SEO Package", deal_value: 2000, deal_stage: "discovery", pipeline_name: "Sales Pipeline", expected_close_date: daysAgo(-30), won_date: null, lost_reason: null, notes: "Discovery call scheduled", contact_name: "Lisa Wong", contact_email: "lisa@greenstart.co", created_at: daysAgo(5), updated_at: daysAgo(1) },
];
...
const crmInsights = [
  { id: "ci1", client_id: DEMO_CLIENT_ID, insight_type: "deal_velocity", priority: "high", title: "TechCorp deal stalled in proposal stage", description: "Deal has been in proposal stage for 12 days", recommended_action: "Schedule follow-up call this week", status: "open", created_at: daysAgo(2) },
];
...
const commandSummary = {
  ...
  topGrowthChannels: [{ channel: "Organic SEO", score: 85 }, { channel: "Local SEO", score: 72 }],
...
const activityLog = [
  ...
  { id: "al5", workspace_id: DEMO_WORKSPACE_ID, client_id: null, user_id: null, actor_name: "Demo Admin", action: "client_created", entity_type: "client", entity_id: "00000000-0000-0000-0000-000000000003", summary: "Created client 'Green Living Co'", metadata_json: {}, created_at: daysAgo(30) },
];
...
const routes: DemoRoute[] = [
  ...
  // Analytics
  { pattern: /^\/clients\/[^/]+\/analytics-connections$/, handler: () => [{ id: "anc1", client_id: DEMO_CLIENT_ID, provider: "gsc", property_id: null, site_url: "https://webby.sg", status: "active", created_at: daysAgo(60), updated_at: now }] },
  ...
  { pattern: /^\/analytics\/sync$/, method: "POST", handler: () => ({ success: true, insights_generated: 3 }) },
  { pattern: /^\/clients\/[^/]+\/performance-summary/, handler: () => performanceSummary },
  { pattern: /^\/clients\/[^/]+\/page-performance/, handler: () => performanceSummary.topPages },
  { pattern: /^\/clients\/[^/]+\/keyword-performance/, handler: () => performanceSummary.topKeywords },
  { pattern: /^\/clients\/[^/]+\/asset-performance/, handler: () => [] },
  { pattern: /^\/clients\/[^/]+\/performance-insights/, handler: () => [] },
  ...
  { pattern: /^\/clients\/[^/]+\/ads-recommendations$/, handler: () => [{ id: "ar1", recommendation_type: "keyword", campaign_name: "SEO Services", ad_group_name: null, keyword_text: "seo consultant singapore", landing_page_url: "/seo-agency", recommended_budget: null, recommended_action: "Add as broad match keyword", priority: "high", status: "open" }] },
  ...
  { pattern: /^\/ai-visibility\/runs\/[^/]+\/observations$/, handler: () => [
    { id: "avo1", run_id: "avr2", prompt_id: "avp1", prompt_text: "What is the best SEO agency in Singapore?", brand_mentioned: true, brand_position: "top_3", competitor_mentioned: true, competitor_names: ["competitor-one.com"], citation_present: true, citation_url: "https://webby.sg", sentiment: "positive", raw_excerpt: "Webby SG is a highly-rated SEO agency in Singapore...", created_at: daysAgo(1) },
    { id: "avo2", run_id: "avr2", prompt_id: "avp2", prompt_text: "Top SEO companies for small business in Singapore", brand_mentioned: true, brand_position: "mentioned", competitor_mentioned: false, competitor_names: [], citation_present: false, citation_url: null, sentiment: "neutral", raw_excerpt: "...including agencies like Webby SG and others...", created_at: daysAgo(1) },
    { id: "avo3", run_id: "avr2", prompt_id: "avp3", prompt_text: "Which agency should I hire for Google SEO in Singapore?", brand_mentioned: false, brand_position: null, competitor_mentioned: true, competitor_names: ["seo-pros.asia"], citation_present: false, citation_url: null, sentiment: null, raw_excerpt: null, created_at: daysAgo(1) },
  ] },
...
export function matchDemoRoute(path: string, method: string = "GET", body?: any): any | undefined {
  ...
  if (upperMethod === "GET") {
    for (const route of routes) {
      if (route.method) continue; // skip routes with explicit method
      const match = cleanPath.match(route.pattern);
      if (match) {
        return route.handler(match, body);
      }
