...
const seoNav = [
  ...
  { title: "Competitor Audit", url: "/competitor-benchmark", icon: Globe, color: "text-seo-primary", perm: "view_dashboard" },
      ...
      <SidebarFooter className="p-4 pt-2 space-y-2">
        ...
        {!collapsed && (
          <div className="rounded-lg bg-muted/50 p-3 border border-border/30">
            ...
            <p className="text-xs font-mono text-muted-foreground">v7.0 — AI Control Tower</p>
          </div>
        )}
      </SidebarFooter>
    </Sidebar>
